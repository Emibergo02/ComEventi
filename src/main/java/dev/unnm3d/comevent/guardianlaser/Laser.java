...
public class Laser {
	...
	private HashSet<Player> show = new HashSet<Player>();
	...
	public Laser(Location start, Location end, int duration, int distance) throws ReflectiveOperationException {
		...
		squid = (Integer) Packets.getField(Packets.packetSpawn, "a", createSquidPacket);
		...
		guardian = (Integer) Packets.getField(Packets.packetSpawn, "a", createGuardianPacket);
